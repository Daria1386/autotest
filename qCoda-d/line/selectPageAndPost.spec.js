...
import PageChanger from './class/SelectPageAndPost.js';
...
describe('First script', function () {
    ...
    it('тест смены количества записей и страниц', async function () {
        let check = new PageChanger(driver);
        await check.selectRecordsPage('25');
    
        let change = new PageChanger(driver);
        await change.changePageAndPost(2, 25);
    });
})