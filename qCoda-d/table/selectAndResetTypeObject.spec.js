...
import StationTypeSelector from './class/SelectAndResetTypeObject.js';
...
describe('First script', function () {
    ...
    it('выбор типа объекта и сброс', async function () {
        let project = new StationTypeSelector(driver);
        await project.selectType('ПС');

        let clean = new StationTypeSelector(driver);
        await clean.cleanSelect();
    });
})