...
import ConFrameSelector from './class/SelectResetConframe.js';
...
describe('First script', function () {
    ...
    it('выбор ConFrame и сброс', async function () {
        let check = new ConFrameSelector(driver);
        await check.typeConFrame('Топологическая модель');

        let clean = new ConFrameSelector(driver);
        await clean.resetConFrame();
    });
})