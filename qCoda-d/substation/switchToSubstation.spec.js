...
import NetworkSwitch from '../network/SwitchToNetwork.js';
import TabSwitcher from './class/SwitchToSubstation.js';
...
describe('First script', function () {
    ...
    it('переключение на Схемы сети', async function () {
        let line = new NetworkSwitch(driver);
        await line.switchNetwork();
    });

    it('переключение на Подстанции', async function () {
        let type = new TabSwitcher(driver);
        await type.switchTabAndAssert();
    });
})