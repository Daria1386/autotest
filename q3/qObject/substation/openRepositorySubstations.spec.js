...
import LineRepositorySwitcher from '../line/classLine/OpenRepositoryLines.js';
import RepositorySwitcher from './classSubstation/OpenRepositorySubstations.js';
...
describe('First script', function () {
    ...
    it('открытие репозитария подстанций', async function () {
        let open = new RepositorySwitcher(driver);
        await open.switchToSubstationsRepository();
    });
});