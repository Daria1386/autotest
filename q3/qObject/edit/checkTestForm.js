...
class SubstationCheck {
    ...
    async checkSubstationInfo() {
        ...
        const open = await this.driver.findElement(By.xpath('//*[@id="substations-list"]/tbody/tr[1]/td[9]/div/a'));
        await open.click();
        ...
        const nameSubstation = await this.driver.findElement(By.xpath('//*[@id="968aae6b-631e-4183-8527-94ae01c4389b"]/table/tbody/tr[1]/td[2]')).getText();
        ...
        const typeSubstation = await this.driver.findElement(By.xpath('//*[@id="968aae6b-631e-4183-8527-94ae01c4389b"]/table/tbody/tr[2]/td[2]')).getText();
        ...
        let voltSubstation = await this.driver.findElement(By.xpath('//*[@id="968aae6b-631e-4183-8527-94ae01c4389b"]/table/tbody/tr[6]/td[2]')).getText();
        ...
        let semanticName = await this.driver.findElement(By.xpath('//*[@id="968aae6b-631e-4183-8527-94ae01c4389b"]/table/tbody/tr[7]/td[2]')).getText();
        ...
        let mrid = await this.driver.findElement(By.xpath('//*[@id="968aae6b-631e-4183-8527-94ae01c4389b"]/table/tbody/tr[8]/td[2]')).getText();
        ...
        let codTM = await this.driver.findElement(By.xpath('//*[@id="968aae6b-631e-4183-8527-94ae01c4389b"]/table/tbody/tr[9]/td[2]')).getText();
        ...
        let conframe = await this.driver.findElement(By.xpath('//*[@id="968aae6b-631e-4183-8527-94ae01c4389b"]/table/tbody/tr[10]/td[2]/span[1]')).getText();
        let conframeForm = await this.driver.findElement(By.id('conframe_id_text'));
